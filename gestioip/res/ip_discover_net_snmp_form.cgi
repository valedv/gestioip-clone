...
print "<p>\n";
print "<form name=\"snmp_version\"  method=\"POST\" action=\"$server_proto://$base_uri/res/ip_discover_net_snmp.cgi\">\n";
print "<table border=\"0\" cellpadding=\"7\">\n";
print "<tr><td align=\"right\"><b>$$lang_vars{redes_message} ${red}/${BM}</b><input type=\"hidden\" name=\"red_num\" value=\"$red_num\"><input type=\"hidden\" name=\"ip_version\" value=\"$ip_version\"><p> </td><td></td></tr>\n";
...
#print "<tr><td><br><input type=\"hidden\" name=\"red_num\" value=\"$red_num\"><input type=\"hidden\" name=\"client_id\" value=\"$client_id\"><input type=\"hidden\" name=\"ip_version\" value=\"$ip_version\"><input type=\"submit\" value=\"$$lang_vars{discover_message}\" name=\"B1\" class=\"input_link_w\" $onclick></td></tr>\n";
#print "</form>\n";
#print "</table>\n";
...
#<tr><td align="right"><b>$$lang_vars{snmp_equipo_message}</b></td><td colspan="3"><input type="text" size="25" name="snmp_node" value="" maxlength="75"> <i>($$lang_vars{ip_o_dns_message})</i></td></tr>
#<tr><td><br></td></tr>
#
#EOF
