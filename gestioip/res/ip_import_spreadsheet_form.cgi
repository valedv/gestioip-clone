...
print "<p>\n";
print "$$lang_vars{upload_spreadsheet_message}\n";
print "<br>\n";
print "<form action=\"$server_proto://$base_uri/res/ip_import_spreadsheet_form1.cgi\" method=\"post\" enctype=\"multipart/form-data\">\n";
