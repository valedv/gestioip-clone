...
print "<tr><td align=\"right\">$$lang_vars{vlan_number_message}</td><td><input name=\"vlan_num\" type=\"text\"  size=\"10\" maxlength=\"10\"></td></tr>\n";
print "<tr><td align=\"right\">$$lang_vars{vlan_name_message}</td><td><input name=\"vlan_name\" type=\"text\"  size=\"15\" maxlength=\"50\"></td></tr>\n";
print "<tr><td align=\"right\">$$lang_vars{vlan_comment_message}</td><td><input name=\"comment\" type=\"text\"  size=\"30\" maxlength=\"500\"></td></tr>\n";
print "<tr><td align=\"right\">$$lang_vars{vlan_provider_message}</td><td>";
my $j=0;
...
print "</table>";
print "<p>\n";
print "<table><tr><td><b>bg</b></td><td><b>font</b></td></tr><tr><td>";
...
print "<br><p><input type=\"hidden\" value=\"$client_id\" name=\"client_id\"><input type=\"submit\" value=\"$$lang_vars{add_message}\" name=\"B2\" class=\"input_link_w_net\"></form><p><br>\n";
