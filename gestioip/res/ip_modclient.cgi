...
#	my $confirmation_on= $gip->get_config_confirmation("$client_id");
#	$gip->insert_config("$client_id","22","254","","yes","","no","n","2","$confirmation_on");
...
if ( $clients[0]->[1] eq "DEFAULT" && $count_clients == "1" ) {
	...
	print "<br><b>$$lang_vars{define_client_message}</b><br><p>\n";
	print "<p><form name=\"insert_client_form\" method=\"POST\" action=\"$server_proto://$base_uri/res/ip_modclient.cgi\">\n";
	print "<table border=\"0\">\n";
	print "<tr><td align=\"right\">$$lang_vars{client_message}</td><td><input name=\"client_name\" type=\"text\"  size=\"15\" maxlength=\"30\"></td></tr>";

	print "<tr><td align=\"right\"><img src=\"$server_proto://$base_uri/imagenes/telefon.png\" title=\"$$lang_vars{phone_message}\"></td><td colspan=\"9\"><input name=\"phone\" type=\"text\"  size=\"15\" maxlength=\"30\" value=\"\"></td></tr>";
	print "<tr><td align=\"right\"><img src=\"$server_proto://$base_uri/imagenes/fax.png\" title=\"$$lang_vars{fax_message}\"></td><td colspan=\"9\"><input name=\"fax\" type=\"text\"  size=\"15\" maxlength=\"30\" value=\"\"></td></tr>";
	print "<tr><td align=\"right\">$$lang_vars{address_message}</td><td colspan=\"9\"><textarea name=\"address\" cols=\"40\" rows=\"4\" maxlength=\"500\">$address</textarea></td></tr>";
	print "<tr><td align=\"right\">$$lang_vars{comentario_message}</td><td colspan=\"9\"><input name=\"comment\" type=\"text\"  size=\"35\" maxlength=\"200\" value=\"$comment\"></td></tr>";
	print "<tr><td colspan=\"10\"></td></tr>\n";
	print "<tr nowrap><td align=\"right\">$$lang_vars{contact_message}</td><td><input name=\"contact_name_1\" type=\"text\" size=\"18\" maxlength=\"200\" value=\"$contact_name_1\"></td><td>&nbsp; <img src=\"$server_proto://$base_uri/imagenes/telefon.png\" title=\"$$lang_vars{phone_message}\"></td><td><input name=\"contact_phone_1\" type=\"text\"  size=\"12\" maxlength=\"25\" value=\"$contact_phone_1\"></td><td>&nbsp; <img src=\"$server_proto://$base_uri/imagenes/handy.png\" title=\"$$lang_vars{cell_message}\"></td><td><input name=\"contact_cell_1\" type=\"text\"  size=\"10\" maxlength=\"25\" value=\"$contact_cell_1\"> </td><td>&nbsp; <img src=\"$server_proto://$base_uri/imagenes/email.png\" title=\"$$lang_vars{mail_message}\"></td><td><input name=\"contact_email_1\" type=\"text\"  size=\"15\" maxlength=\"50\" value=\"$contact_email_1\"> </td><td>&nbsp; $$lang_vars{comentario_message}</td><td><input name=\"contact_comment_1\" type=\"text\"  size=\"22\" maxlength=\"50\" value=\"$contact_comment_1\"></td></tr>";
	print "<tr nowrap><td align=\"right\">$$lang_vars{contact_message}</td><td><input name=\"contact_name_2\" type=\"text\" size=\"18\" maxlength=\"200\" value=\"$contact_name_2\"></td><td>&nbsp; <img src=\"$server_proto://$base_uri/imagenes/telefon.png\" title=\"$$lang_vars{phone_message}\"></td><td><input name=\"contact_phone_2\" type=\"text\"  size=\"12\" maxlength=\"25\" value=\"$contact_phone_2\"></td><td>&nbsp; <img src=\"$server_proto://$base_uri/imagenes/handy.png\" title=\"$$lang_vars{cell_message}\"></td><td><input name=\"contact_cell_2\" type=\"text\"  size=\"10\" maxlength=\"25\" value=\"$contact_cell_2\"> </td><td>&nbsp; <img src=\"$server_proto://$base_uri/imagenes/email.png\" title=\"$$lang_vars{mail_message}\"></td><td><input name=\"contact_email_2\" type=\"text\"  size=\"15\" maxlength=\"50\" value=\"$contact_email_2\"> </td><td>&nbsp; $$lang_vars{comentario_message}</td><td><input name=\"contact_comment_2\" type=\"text\"  size=\"22\" maxlength=\"50\" value=\"$contact_comment_2\"></td></tr>";
	print "<tr nowrap><td align=\"right\">$$lang_vars{contact_message}</td><td><input name=\"contact_name_3\" type=\"text\" size=\"18\" maxlength=\"200\" value=\"$contact_name_3\"></td><td>&nbsp; <img src=\"$server_proto://$base_uri/imagenes/telefon.png\" title=\"$$lang_vars{phone_message}\"></td><td><input name=\"contact_phone_3\" type=\"text\"  size=\"12\" maxlength=\"25\" value=\"$contact_phone_3\"></td><td>&nbsp; <img src=\"$server_proto://$base_uri/imagenes/handy.png\" title=\"$$lang_vars{cell_message}\"></td><td><input name=\"contact_cell_3\" type=\"text\"  size=\"10\" maxlength=\"25\" value=\"$contact_cell_3\"> </td><td>&nbsp; <img src=\"$server_proto://$base_uri/imagenes/email.png\" title=\"$$lang_vars{mail_message}\"></td><td><input name=\"contact_email_3\" type=\"text\"  size=\"15\" maxlength=\"50\" value=\"$contact_email_3\"> </td><td>&nbsp; $$lang_vars{comentario_message}</td><td><input name=\"contact_comment_3\" type=\"text\"  size=\"22\" maxlength=\"50\" value=\"$contact_comment_3\"></td></tr>";
...
function confirmation() {
        ...
        answer = confirm("$$lang_vars{delete_client_confirme_message} \($$lang_vars{redes_dispo_message}: $anz_red_all/$$lang_vars{hosts1_message}: $anz_host_all\)?")
...
EOF
	...
	print "<p><b>$$lang_vars{edit_client_message}</b><br>\n";
	...
	print "<table border=\"0\">\n";
	print "<tr><td align=\"right\">$$lang_vars{client_message}</td><td colspan=\"1\">";

	print "<select name=\"client_id\" size=\"1\" onchange=\"DisableEnableForm(document.modificar1_client_form,true);B2_mod.style.display='none';B1_mod.style.display='inline';\">\n";
	$j=0;
	foreach (@clients) {
...
#	print "<input name=\"client_action\" type=\"hidden\" value=\"update_view\"><input name=\"mode\" type=\"hidden\" value=\"edit_client\"> <input type=\"submit\" value=\"\" name=\"B2_mod\" class=\"edit_button\" id=\"B2_mod\" style='display:inline;' title=\"$$lang_vars{actualize_client}\">\n";
	...
	print "<tr><td align=\"right\" colspan=\"10\"><form name=\"modificar1_client_form\" id=\"modificar1_client_form\" method=\"POST\" action=\"$server_proto://$base_uri/res/ip_modclient.cgi\">\n";
print "</td></tr>";

	print "<tr><td align=\"right\"><img src=\"$server_proto://$base_uri/imagenes/telefon.png\" title=\"$$lang_vars{phone_message}\"></td><td colspan=\"9\">$phone</td></tr>" if $phone;
	print "<tr><td align=\"right\"><img src=\"$server_proto://$base_uri/imagenes/fax.png\" title=\"$$lang_vars{fax_message}\"></td><td colspan=\"9\">$fax</td></tr>" if $fax;
	print "<tr><td align=\"right\" valign=\"top\"><b>$$lang_vars{address_message}</b></td><td colspan=\"9\">$address</td></tr>" if $address;
	print "<tr><td align=\"right\"><b>$$lang_vars{comentario_message}</b></td><td colspan=\"9\">$comment</td></tr>" if $comment;
	print "<tr><td colspan=\"10\"></td></tr>\n";
	print "<tr nowrap><td align=\"right\"><b>$$lang_vars{contact_message}</b></td><td>$contact_name_1</td><td>&nbsp; <img src=\"$server_proto://$base_uri/imagenes/telefon.png\" title=\"$$lang_vars{phone_message}\"></td><td>$contact_phone_1</td><td>&nbsp; <img src=\"$server_proto://$base_uri/imagenes/handy.png\" title=\"$$lang_vars{cell_message}\"></td><td>$contact_cell_1</td><td>&nbsp; <img src=\"$server_proto://$base_uri/imagenes/email.png\" title=\"$$lang_vars{mail_message}\"></td><td>$contact_email_1 </td><td>&nbsp;</td><td>$contact_comment_1</td></tr>\n" if $contact_name_1;
...
print "<p><form name=\"modificar_client_form\" id=\"modificar_client_form\" method=\"POST\" action=\"$server_proto://$base_uri/res/ip_modclient.cgi\">\n";
print "<table border=\"0\">\n";
print "<tr><td align=\"right\">$$lang_vars{client_message}</td><td colspan=\"9\">";

print "<select name=\"client_id\" size=\"1\" onchange=\"DisableEnableForm(document.modificar1_client_form,true);B1.style.display='inline';\">\n";
foreach (@clients) {
	if ( $clients[$j]->[0] == "$client_id") {
		print "<option value=\"$clients[$j]->[0]\" selected>$clients[$j]->[1]</option>";
		$j++;
...
print "<tr><td align=\"right\"><form name=\"modificar1_client_form\" id=\"modificar1_client_form\" method=\"POST\" action=\"$server_proto://$base_uri/res/ip_modclient.cgi\">$$lang_vars{client_message}</td><td colspan=\"9\"><input name=\"client_name\" type=\"text\"  size=\"15\" maxlength=\"30\" value=\"$client_name\"></td></tr>";

print "<tr><td align=\"right\"><img src=\"$server_proto://$base_uri/imagenes/telefon.png\" title=\"$$lang_vars{phone_message}\"></td><td colspan=\"9\"><input name=\"phone\" type=\"text\"  size=\"15\" maxlength=\"30\" value=\"$phone\"></td></tr>";
print "<tr><td align=\"right\"><img src=\"$server_proto://$base_uri/imagenes/fax.png\" title=\"$$lang_vars{fax_message}\"></td><td colspan=\"9\"><input name=\"fax\" type=\"text\"  size=\"15\" maxlength=\"30\" value=\"$fax\"></td></tr>";
print "<tr><td align=\"right\">$$lang_vars{address_message}</td><td colspan=\"9\"><textarea name=\"address\" cols=\"40\" rows=\"4\" maxlength=\"500\">$address</textarea></td></tr>";
print "<tr><td align=\"right\">$$lang_vars{comentario_message}</td><td colspan=\"9\"><input name=\"comment\" type=\"text\"  size=\"35\" maxlength=\"200\" value=\"$comment\"></td></tr>";
print "<tr><td colspan=\"10\"></td></tr>\n";
print "<tr nowrap><td align=\"right\">$$lang_vars{contact_message}</td><td><input name=\"contact_name_1\" type=\"text\" size=\"18\" maxlength=\"200\" value=\"$contact_name_1\"></td><td>&nbsp; <img src=\"$server_proto://$base_uri/imagenes/telefon.png\" title=\"$$lang_vars{phone_message}\"></td><td><input name=\"contact_phone_1\" type=\"text\"  size=\"12\" maxlength=\"25\" value=\"$contact_phone_1\"></td><td>&nbsp; <img src=\"$server_proto://$base_uri/imagenes/handy.png\" title=\"$$lang_vars{cell_message}\"></td><td><input name=\"contact_cell_1\" type=\"text\"  size=\"10\" maxlength=\"25\" value=\"$contact_cell_1\"> </td><td>&nbsp; <img src=\"$server_proto://$base_uri/imagenes/email.png\" title=\"$$lang_vars{mail_message}\"></td><td><input name=\"contact_email_1\" type=\"text\"  size=\"15\" maxlength=\"50\" value=\"$contact_email_1\"> </td><td>&nbsp; $$lang_vars{comentario_message}</td><td><input name=\"contact_comment_1\" type=\"text\"  size=\"22\" maxlength=\"50\" value=\"$contact_comment_1\"></td></tr>";
...
print "<p><b>$$lang_vars{add_client_message}</b><p>\n";

print "<p><form name=\"insert_client_form\" method=\"POST\" action=\"$server_proto://$base_uri/res/ip_modclient.cgi\">\n";
print "<table border=\"0\">\n";
print "<tr><td>$$lang_vars{client_name_message}</td><td><input name=\"client_name\" type=\"text\" size=\"15\" maxlength=\"30\"></td></tr>";
print "<tr><td align=\"right\">sites</td><td colspan=\"4\"><input name=\"loc\" type=\"text\"  size=\"20\" maxlength=\"200\"> <i>$$lang_vars{list_of_sites_message}</i></td></tr>";

print "<tr><td align=\"right\"><img src=\"$server_proto://$base_uri/imagenes/telefon.png\" title=\"$$lang_vars{phone_message}\"></td><td colspan=\"9\"><input name=\"phone\" type=\"text\"  size=\"15\" maxlength=\"30\" value=\"\"></td></tr>";
print "<tr><td align=\"right\"><img src=\"$server_proto://$base_uri/imagenes/fax.png\" title=\"$$lang_vars{fax_message}\"></td><td colspan=\"9\"><input name=\"fax\" type=\"text\"  size=\"15\" maxlength=\"30\" value=\"\"></td></tr>";
print "<tr><td align=\"right\">$$lang_vars{address_message}</td><td colspan=\"9\"><textarea name=\"address\" cols=\"40\" rows=\"4\" maxlength=\"500\"></textarea></td></tr>";
print "<tr><td align=\"right\">$$lang_vars{comentario_message}</td><td colspan=\"9\"><input name=\"comment\" type=\"text\"  size=\"35\" maxlength=\"200\" value=\"\"></td></tr>";
print "<tr><td colspan=\"10\"></td></tr>\n";
print "<tr nowrap><td align=\"right\">$$lang_vars{contact_message}</td><td><input name=\"contact_name_1\" type=\"text\" size=\"18\" maxlength=\"200\" value=\"\"></td><td>&nbsp; <img src=\"$server_proto://$base_uri/imagenes/telefon.png\" title=\"$$lang_vars{phone_message}\"></td><td><input name=\"contact_phone_1\" type=\"text\"  size=\"12\" maxlength=\"25\" value=\"\"></td><td>&nbsp; <img src=\"$server_proto://$base_uri/imagenes/handy.png\" title=\"$$lang_vars{cell_message}\"></td><td><input name=\"contact_cell_1\" type=\"text\"  size=\"10\" maxlength=\"25\" value=\"\"> </td><td>&nbsp; <img src=\"$server_proto://$base_uri/imagenes/email.png\" title=\"$$lang_vars{mail_message}\"></td><td><input name=\"contact_email_1\" type=\"text\"  size=\"15\" maxlength=\"50\" value=\"\"> </td><td>&nbsp; $$lang_vars{comentario_message}</td><td><input name=\"contact_comment_1\" type=\"text\"  size=\"22\" maxlength=\"50\" value=\"\"></td></tr>";
print "<tr nowrap><td align=\"right\">$$lang_vars{contact_message}</td><td><input name=\"contact_name_2\" type=\"text\" size=\"18\" maxlength=\"200\" value=\"\"></td><td>&nbsp; <img src=\"$server_proto://$base_uri/imagenes/telefon.png\" title=\"$$lang_vars{phone_message}\"></td><td><input name=\"contact_phone_2\" type=\"text\"  size=\"12\" maxlength=\"25\" value=\"\"></td><td>&nbsp; <img src=\"$server_proto://$base_uri/imagenes/handy.png\" title=\"$$lang_vars{cell_message}\"></td><td><input name=\"contact_cell_2\" type=\"text\"  size=\"10\" maxlength=\"25\" value=\"\"> </td><td>&nbsp; <img src=\"$server_proto://$base_uri/imagenes/email.png\" title=\"$$lang_vars{mail_message}\"></td><td><input name=\"contact_email_2\" type=\"text\"  size=\"15\" maxlength=\"50\" value=\"\"> </td><td>&nbsp; $$lang_vars{comentario_message}</td><td><input name=\"contact_comment_2\" type=\"text\"  size=\"22\" maxlength=\"50\" value=\"\"></td></tr>";
print "<tr nowrap><td align=\"right\">$$lang_vars{contact_message}</td><td><input name=\"contact_name_3\" type=\"text\" size=\"18\" maxlength=\"200\" value=\"\"></td><td>&nbsp; <img src=\"$server_proto://$base_uri/imagenes/telefon.png\" title=\"$$lang_vars{phone_message}\"></td><td><input name=\"contact_phone_3\" type=\"text\"  size=\"12\" maxlength=\"25\" value=\"\"></td><td>&nbsp; <img src=\"$server_proto://$base_uri/imagenes/handy.png\" title=\"$$lang_vars{cell_message}\"></td><td><input name=\"contact_cell_3\" type=\"text\"  size=\"10\" maxlength=\"25\" value=\"\"> </td><td>&nbsp; <img src=\"$server_proto://$base_uri/imagenes/email.png\" title=\"$$lang_vars{mail_message}\"></td><td><input name=\"contact_email_3\" type=\"text\"  size=\"15\" maxlength=\"50\" value=\"\"> </td><td>&nbsp; $$lang_vars{comentario_message}</td><td><input name=\"contact_comment_3\" type=\"text\"  size=\"22\" maxlength=\"50\" value=\"\"></td></tr>";
...
print "<p><b>$$lang_vars{delete_client_message}</b><p>\n";
print "<form  method=\"POST\" action=\"$server_proto://$base_uri/res/ip_modclient.cgi\">\n";
print "<select name=\"client_id\" size=\"1\">\n";
$j=0;
foreach (@clients) {
	if ( $clients[$j]->[0] == "$client_id") {
		print "<option value=\"$clients[$j]->[0]\" selected>$clients[$j]->[1]</option>";
...
print "</select>\n";
print "<td><p><input name=\"client_action\" type=\"hidden\" value=\"delete_client\"><input name=\"client_name\" type=\"hidden\" value=\"\"><input name=\"mode\" type=\"hidden\" value=\"$mode\"><input type=\"submit\" value=\"$$lang_vars{borrar_message}\" name=\"B1\" class=\"input_link_w\" $onclick></td></tr>\n";
print "</form>\n";
