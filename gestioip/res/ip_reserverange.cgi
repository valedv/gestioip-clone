...
my $utype_id=$gip->get_utype_id("$client_id","dns");
...
print "TEST: $reserve_start_address - $reserve_end_address<br>\n";
	...
	my @ch=$gip->get_host("$client_id","$reserve_start_address_int","$reserve_end_address_int");
	my $j=0;
...
print "TEST: $reserve_start_address - $reserve_end_address<br>\n";
	...
	my @ch=$gip->get_host("$client_id","$start_ip_int","$end_ip_int");
...
my $pages_links=$gip->get_pages_links_host("$client_id","$start_entry_hosts","$anz_values_hosts","$entries_per_page_hosts","$red_num","$knownhosts","$host_order_by","$first_ip_int",$host_hash_ref,"$broad_ip_int");
