...
print "<p>$$lang_vars{new_vlan_name_message}<p>\n";
...
while ( my ($key, @value) = each(%vlans) ) {
	...
	print "<input type=\"radio\" name=\"vlan_id\" value=\"$key\"> $value[0]->[1]<br>\n";
}


print "<p><input type=\"hidden\" value=\"$vlan_ids\" name=\"vlan_ids\"><input name=\"client_id\" type=\"hidden\" value=\"$client_id\"><input type=\"submit\" value=\"$$lang_vars{submit_message}\" name=\"B2\" class=\"input_link_w\">\n";
print "</form>\n";
