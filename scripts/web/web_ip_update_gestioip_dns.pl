...
my ( $disable_audit, $test, $verbose, $mail, $help, $version_arg, $community_arg,$community,$client_id,$snmp_version,$lang,$gip_config_file,$user,$with_spreadsheet,$max_sync_procs );
